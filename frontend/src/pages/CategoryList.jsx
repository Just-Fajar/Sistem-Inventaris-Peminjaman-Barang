...
function CategoryList() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Manajemen Kategori</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Kelola kategori barang inventaris</p>
      </div>

      {/* Actions Bar */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm p-4 mb-6">
